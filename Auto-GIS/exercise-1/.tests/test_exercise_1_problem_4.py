...
class Test_Exercise_1_Problem_4:
    ...
    @points(
        1, "Problem 4: the result of calculating `total_length` does not seem correct"
    )
    ...
    @points(1, "Problem 4: revisit `create_od_lines()`, it does not work as expected")
    ...
    @points(
        0.25,
        "Problem 4: the function `calculate_total_distance()` does " "have a docstring",
    )
